...
class Ads
{
  ...
  public:
    Ads(AmsAddr* SrcAddr, AmsAddr* DestAddr, char* DestBIp);
    Ads();
    ...
    uint32_t GetVaraibleHandleByName(String VarName, HANDLE &u32VarHandle);
    uint32_t WritePlcVarByName(String VarName, void* pWrData, size_t WrLen);
    uint32_t ReadPlcVarByName(String VarName, void* pRdData, size_t RdLen);
