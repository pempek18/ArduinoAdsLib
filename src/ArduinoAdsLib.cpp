...
uint32_t ADS::Ads::GetVaraibleHandleByName(String VarName, ADS::HANDLE &Handle)
{
    sADS_RESP_READ_t ReadResponse;
    uint32_t u32AdsRetVal;

    this->ReadWrite(ADSIGRP_SYM_HNDBYNAME, 0, sizeof(ADS::HANDLE), VarName.length(), (void*)VarName.c_str(), &ReadResponse);
...
uint32_t ADS::Ads::WritePlcVarByName(String VarName, void* pWrData, size_t WrLen)
{
    sADS_RESP_READ_t ReadResponse;
    ADS::HANDLE Handle;
    uint32_t u32AdsRetVal;
...
uint32_t ADS::Ads::ReadPlcVarByName(String VarName, void* pRdData, size_t RdLen)
{
    sADS_RESP_READ_t ReadResponse;
    ADS::HANDLE Handle;
    uint32_t u32AdsRetVal;
